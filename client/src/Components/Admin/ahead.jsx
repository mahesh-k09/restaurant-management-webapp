...
<nav class="vertical-nav">
    <ul class="nav-links" style={{marginTop:"40px"}}>
        <li><Link to={"/adminHome"} style={{fontSize:"20px"}}>Admin Home</Link></li>
        <li><Link to={"/categories"} style={{fontSize:"20px"}}>Food Categories</Link></li>
        <li><Link to={"/managers"} style={{fontSize:"20px"}}>Managers</Link></li>
        <li><Link to={"/viewFood"} style={{fontSize:"20px"}}>View Food</Link></li>
