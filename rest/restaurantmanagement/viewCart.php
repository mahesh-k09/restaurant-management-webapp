...
if (isset($headers['Authorization'])) {
    ...
    if ($type === 'Bearer') {
        ...
        $sql = "select cart.cart_id,cart.customer_id,cart.date,cart.status,cart.totalPrice,cartitems.cartitemId,cartitems.food_id,cartitems.quantity,food.food_title,food.price FROM 
            cart
        LEFT JOIN 
    ...
    food ON cartitems.food_id = food.food_id
        WHERE 
            cart.customer_id ='".$customer_id."' and cart.status='Cart'";
