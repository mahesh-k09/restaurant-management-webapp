...
if (isset($headers['Authorization'])) {
    ...
    if ($type === 'Bearer') {
        ...
        $sql = "select cart.cart_id,cart.customer_id,customers.name,cart.date,cart.status,cart.totalPrice,cart.orderType,cart.deliveryBoyName,cart.phone,cartitems.cartitemId,cartitems.food_id,cartitems.quantity,food.food_title,food.price FROM 
            cart
            JOIN 
    ...
    food ON cartitems.food_id = food.food_id
        WHERE 
            cart.customer_id ='".$customer_id."' and (cart.status='Delivered' or cart.status='Cancelled' or cart.status='Rejected')";
    ...
    customers ON cart.customer_id = customers.customer_id
        ...
        food ON cartitems.food_id = food.food_id
            WHERE 
                 (cart.status='Delivered' or cart.status='Cancelled' or cart.status='Rejected') ";
            $result = $conn->query($sql);
